...
guitar6 = Guitar("Les Paul","Green",manufacturer1,"electric",6,2015,400,550)
guitar_repostiory.save(guitar6)
guitar7 = Guitar("Les Paul","Sunburst",manufacturer1,"electric",6,2015,400,550)
guitar_repostiory.save(guitar7)
guitar8 = Guitar("Les Paul","Red",manufacturer1,"electric",6,2015,400,550)
guitar_repostiory.save(guitar8)
guitar9 = Guitar("Academy 200","Black",manufacturer2,"Acoustic",6,2020,200,350)
guitar_repostiory.save(guitar9)
guitar10 = Guitar("Academy 100","Red",manufacturer2,"Acoustic",6,2020,200,350)
guitar_repostiory.save(guitar10)
guitar11 = Guitar("Telecaster","Black",manufacturer3,"electric",6,2009,340,500)
guitar_repostiory.save(guitar11)
guitar12 = Guitar("Telecaster","White",manufacturer3,"electric",6,2009,340,500)
